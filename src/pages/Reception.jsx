  ...
  if (isMobileBlock) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center animate-in zoom-in-95">
        ...
        <h2 className="text-2xl font-bold text-[#021D34] dark:text-white mb-3">
          Acesso Restrito
        </h2>
    ...
    return (
      <div className="animate-in zoom-in">
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 text-center max-w-3xl mx-auto shadow-xl transition-colors">
          ...
          <h2 className="text-2xl font-bold text-[#021D34] dark:text-white">
          ...
          <div className="flex justify-center gap-4 mb-8 mt-6">
            <button
              ...
              className="bg-[#021D34] dark:bg-slate-700 text-white px-6 py-3 rounded-lg font-bold flex items-center gap-2 hover:bg-[#032d50] dark:hover:bg-slate-600 transition-colors shadow-lg"
            >
            ...
            <button
              ...
              className="border border-slate-200 dark:border-slate-600 px-6 py-3 rounded-lg font-bold hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 transition-colors"
            >
              Novo Atendimento
            </button>
          </div>
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div
            className={`bg-white dark:bg-slate-800 p-6 rounded-2xl border transition-all duration-300 ${selectedStudent ? "border-[#009DE0] dark:border-[#009DE0]" : "border-slate-200 dark:border-slate-700"}`}
          >
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-lg flex items-center gap-2 text-[#021D34] dark:text-white">
                <span className="w-6 h-6 rounded-full bg-[#021D34] dark:bg-slate-700 text-white flex items-center justify-center text-xs">
                  1
                </span>{" "}
                Identificação
              </h3>
            ...
            {!selectedStudent ? (
                    ...
                    {studentResults.map((s) => (
                      ...
                      >
                        <div className="flex justify-between">
                          <div>
                            <p className="font-bold text-[#021D34] dark:text-white">
                              {s.name}
                            </p>
              ...
              <div className="flex items-center gap-4 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-900/30 transition-colors">
                ...
                <div>
                  <p className="font-bold text-[#021D34] dark:text-white text-lg">
          ...
          <div
            className={`bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 transition-all duration-300 ${!selectedStudent ? "opacity-50 pointer-events-none" : "opacity-100"}`}
          >
              ...
              {visibleTypes.map((t) => {
                ...
                return (
                  ...
                  >
                    ...
                    <PackagePlus
                      size={24}
                      className={isSelected ? "text-white" : "text-slate-400 dark:text-slate-500 group-hover:text-white transition-colors"}
                    />
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 h-fit sticky top-4 shadow-sm transition-colors">
          ...
          <div className="space-y-2 mb-6 max-h-[300px] overflow-y-auto custom-scrollbar">
            {cart.length === 0 ? (
              ...
              cart.map((item) => (
                <div
                  key={item.uid}
                  className="flex justify-between items-center bg-slate-50 dark:bg-slate-900/50 p-3 rounded-lg border border-slate-100 dark:border-slate-700 transition-colors animate-in fade-in slide-in-from-left-2"
                >
          ...
          {!isOnline && (
            <p className="text-xs text-center text-orange-600 dark:text-orange-400 mt-2 font-bold">

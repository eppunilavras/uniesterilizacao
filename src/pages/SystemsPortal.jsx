      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white mb-6 tracking-tight leading-[1.1]">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#009DE0] to-blue-600 dark:from-[#38bdf8] dark:to-blue-400">
              Odontologia
            </span>{" "}
            Unilavras
          </h1>
                ...
                const CardContent = () => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100 mb-2 group-hover:text-[#009DE0] dark:group-hover:text-[#38bdf8] transition-colors">
                        {link.name}
                      </h3>

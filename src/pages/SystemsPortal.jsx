...
export default function SystemsPortal() {
  ...
  return (
    <div className="min-h-screen bg-slate-50] relative overflow-x-hidden font-sans selection:bg-blue-200 selection:text-blue-900 transition-colors duration-300">
{/* --- Background --- */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="hidden md:block absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" />
        <div className="hidden md:block absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000" />
        <div className="hidden md:block absolute -bottom-8 left-20 w-72 h-72 bg-teal-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000" />
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight leading-[1.1]">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#009DE0] to-blue-600]">
              Odontologia
            </span>{" "}
            Unilavras
          </h1>
          ...
          <p className="text-lg text-slate-600 mb-10 leading-relaxed max-w-xl mx-auto">
            Acesse as ferramentas, portais e recursos do curso em um único
            lugar.
          </p>
                ...
                const CardContent = () => (
                  <div
                    className="
                                  ...
                                  bg-white md:bg-white/70 md:backdrop-blur-none md:backdrop-blur-lg 
                                  border border-slate-100 md:border-white/60 md:rounded-3xl shadow-sm 
                  ...
                  >
                    <div
                      className="
                                      w-12 h-12 rounded-2xl bg-gradient-to-br from-white to-blue-50
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-[#009DE0]] transition-colors">
                        {link.name}
                      </h3>
      ...
      <footer className="py-8 text-center relative z-10 border-t border-slate-200/50 bg-white/30 backdrop-blur-sm">
        ...
        <p className="text-slate-400 text-[10px] uppercase tracking-widest font-bold">
          © {new Date().getFullYear()} Centro Universitario de Lavras -
          Unilavras
        </p>
      </footer>
    </div>

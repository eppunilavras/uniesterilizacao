...
export default function AdminPanel({ userProfile }) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in">
            ...
            <div className="md:hidden grid grid-cols-2 gap-2 mb-4">
                 {tabs.map(t => (
                    <button 
                        ...
                        ${activeTab === t.id 
                            ? 'bg-[#009DE0] text-white border-[#009DE0] shadow-md' 
            ...
            <div className="hidden md:flex gap-2 border-b border-slate-200 overflow-x-auto pb-1 no-scrollbar transition-colors">
                {tabs.map(t => (
                    <button 
                        key={t.id} 
                        onClick={() => setActiveTab(t.id)} 
                        ...
                        ${activeTab === t.id 
                            ? 'border-[#009DE0] text-[#009DE0] bg-white' 
            ...
            {/* Área de Conteúdo */}
            <div className="bg-white p-4 md:p-6 rounded-b-xl md:rounded-tr-xl border border-slate-200 md:border-t-0 shadow-sm min-h-[400px] rounded-xl md:rounded-tl-none transition-colors">

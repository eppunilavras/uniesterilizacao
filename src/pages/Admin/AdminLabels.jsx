                            ...
                            <div className={`space-y-6 transition-opacity duration-300 ${settings.showHeader ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
                                ...
                                {settings.showTitle && (
                                    <div className="p-3 border rounded-lg bg-slate-50/50 dark:bg-slate-900/30 dark:border-slate-700">
                                        ...
                                        <div className="space-y-3">
                                            <div><div className="flex justify-between"><label className="text-[10px] font-bold text-slate-500 dark:text-slate-400">Tamanho Fonte</label><span className="text-[10px] text-slate-400">{settings.headerFontSize}px</span></div><input type="range" min="6" max="32" className="w-full accent-[#009DE0]" value={settings.headerFontSize} onChange={e => setSettings({...settings, headerFontSize: Number(e.target.value)})}/></div>
                                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {settings.showTitle && (
                                    <div className="p-3 border rounded-lg bg-slate-50/50 dark:bg-slate-900/30 dark:border-slate-700">
                                        ...
                                        <div className="space-y-3">
                                            <div><div className="flex justify-between"><label className="text-[10px] font-bold text-slate-500 dark:text-slate-400">Tamanho Fonte</label><span className="text-[10px] text-slate-400">{settings.subheaderFontSize}px</span></div><input type="range" min="4" max="32" className="w-full accent-[#009DE0]" value={settings.subheaderFontSize} onChange={e => setSettings({...settings, subheaderFontSize: Number(e.target.value)})}/></div>
                                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {settings.showDate && (
                                    <div className="p-3 border rounded-lg bg-slate-50/50 dark:bg-slate-900/30 dark:border-slate-700">
                                        ...
                                        <div className="space-y-3">
                                            <div><div className="flex justify-between"><label className="text-[10px] font-bold text-slate-500 dark:text-slate-400">Tamanho Fonte</label><span className="text-[10px] text-slate-400">{settings.dateFontSize}px</span></div><input type="range" min="4" max="32" className="w-full accent-[#009DE0]" value={settings.dateFontSize} onChange={e => setSettings({...settings, dateFontSize: Number(e.target.value)})}/></div>
                                            <div className="grid grid-cols-2 gap-4">
                    ...
                    {activeTab === 'footer' && (
                        <div className="space-y-5 animate-in fade-in">
                            ...
                            <div className={`space-y-4 transition-opacity ${settings.showFooter ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
                                <div><div className="flex justify-between mb-1"><label className="text-xs font-bold text-slate-500 dark:text-slate-400">Tamanho Texto</label></div><input type="range" min="6" max="32" className="w-full accent-[#009DE0]" value={settings.footerFontSize} onChange={e => setSettings({...settings, footerFontSize: Number(e.target.value)})} /></div>

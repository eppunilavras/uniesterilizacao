            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1 flex gap-2">
                    <div className="relative flex-1">
                        ...
                        <input 
                            className="w-full pl-10 p-2 border rounded-lg text-sm outline-none focus:border-[#009DE0] focus:ring-1 focus:ring-[#009DE0] bg-white border-slate-200 text-slate-900 transition-colors placeholder:text-slate-400" 
                    ...
                    <button 
                        ...
                        className="p-2 border rounded-lg hover:bg-slate-50 text-slate-500 active:scale-95 transition-all"
                ...
                <select 
                    className="p-2 border rounded-lg text-sm outline-none w-full md:w-auto bg-white border-slate-200 text-slate-900 transition-colors" 
                    value={filterType} 
